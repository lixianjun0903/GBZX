...
@implementation PushTabelVewiCell
...
-(void)createUI
{
    ...
    //学习人数
    leanNumberLabel = [MyContol createLabelWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 100, 65, 90, 20) Font:14 Text:@"已有10选学"];
...
-(void)config:(PushMOdel*)model
{
    ...
    //学习人数
    leanNumberLabel.text = [NSString stringWithFormat:@"已有%d人选学",model.studyNum];
