...
@interface MyClassRightView()<UITableViewDataSource,UITableViewDelegate>
{
...
@end
@implementation MyClassRightView
@synthesize mLoadMsg;
...
-(void)loadData
{
    ...
    NSString * urlstr = [NSString stringWithFormat:@"%@api/student/getMyFinishedCourseList.json?studentId=%@",BASEURL,strID];
