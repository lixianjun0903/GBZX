...
@interface MyClassMidelView()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation MyClassMidelView
@synthesize mLoadMsg;
...
-(void)loadData
{
    ...
    NSString * urlstr = [NSString stringWithFormat:@"%@api/student/getMyOptionalCourseList.json?studentId=%@",BASEURL,strID];
