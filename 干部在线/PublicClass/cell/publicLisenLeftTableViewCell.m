...
//
//  publicLisenLeftTableViewCell.m
//  干部在线
//
...
@implementation publicLisenLeftTableViewCell
...
-(void)createUI
{
    ...
    //评论时间
    timeLabel = [MyContol createLabelWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 160,20, self.frame.size.width - 130,20) Font:14 Text:@"2014:09:02"];
    timeLabel.textColor =[UIColor grayColor];
    timeLabel.font = [UIFont systemFontOfSize:13];
    timeLabel.textColor = [UIColor colorWithRed:0.3 green:0.34 blue:0.3 alpha:1];
    [self.contentView addSubview:timeLabel];
    //评论内容
    contentLabel = [MyContol createLabelWithFrame:CGRectMake(80, 60, self.contentView .frame.size.width - 70, 20) Font:13 Text:@"经过这次的培训，使我受益匪浅"];
