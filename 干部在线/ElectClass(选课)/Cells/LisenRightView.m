...
#import "LisenRiightTableViewCell.h"
#import "LisenRightModel.h"
#import "JSON.h"
#import "ImageDownManager.h"
@interface LisenRightView()
...
{
    LisenRiightTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"ID"];
    if (!cell) {
        cell = [[LisenRiightTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ID"];
    }
